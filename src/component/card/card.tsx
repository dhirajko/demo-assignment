  ...
  return (
    <div className="card" style={generateColorStyle()}>
      <div className="card-upper-container">
        <span aria-hidden className="close-button" onClick={() => removeProject(id)}>x</span>
      ...
      <div className="card-body">
        ...
        <div className="card-details">
          ...
          <span>
            {[...Array(parseInt(rating, 10))].map((value, i) => <img key={i} src={Star} alt="Star" height={15} />)}
          </span>
        </div>
      </div>
    </div>
